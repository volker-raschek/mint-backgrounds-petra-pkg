...
```bash
git clone https://aur.archlinux.org/mint-backgrounds-petra.git
cd mint-backgrounds-petra
makepkg
```
...
```bash
yay --sync --aur mint-backgrounds-petra
```
...
sudo pacman --sync mint-backgrounds-petra
```
